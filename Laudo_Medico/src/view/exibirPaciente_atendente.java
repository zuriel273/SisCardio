 ...
 * @author arlindo
 */
public class exibirPaciente_atendente extends javax.swing.JFrame {

    DefaultTableModel modelo;
    /**
     * Creates new form buscaPaciente
     */
    public exibirPaciente_atendente(){
        ...
        try {
            ...
            Logger.getLogger(exibirPaciente_atendente.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(20, 20, 620, 30);
        ...
        jButton_editar.setBounds(20, 580, 120, 50);
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel1Layout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(jDesktopPane_Geral, javax.swing.GroupLayout.DEFAULT_SIZE, 678, Short.MAX_VALUE)))
        );
    ...
    private void jButton_editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_editarActionPerformed
        try {
            ...
            this.setAlwaysOnTop(false);
            new editaCadastroPaciente(paciente).setVisible(true);
            this.dispose();
